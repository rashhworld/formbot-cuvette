    ...
    return (
        <section className={`${styles.postBanner} ${bstyles.banner}`}>
            <div className={`${styles.vector} ${bstyles.vector}`}>
                ...
                <img className={`${styles.triangle} ${bstyles.triangle}`} src="images/vectors/triangle-single.png" alt="" />
                <img className={`${styles.semiCircle} ${bstyles.semiCircle}`} src="images/vectors/semi-circle.png" alt="" />
            </div>
        </section>
    );
}
